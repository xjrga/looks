 ...
 */
public class Harmonic270 implements HarmonicColor, Comparable<HarmonicColor> {

    private Color baseColor = null;
    private final ColorGenerator colorGenerator;
    private final Color newColor;
    private final float angleChange = 270f;
     ...
     * @see java.awt.Color
     */
    public Harmonic270(Color color) {
