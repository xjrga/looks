 ...
 */
public class Harmonic315 implements HarmonicColor, Comparable<HarmonicColor> {

    private Color baseColor = null;
    private final ColorGenerator colorGenerator;
    private final Color newColor;
    private final float angleChange = 315f;
     ...
     * @see java.awt.Color
     */
    public Harmonic315(Color color) {
